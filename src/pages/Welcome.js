...
import {Link} from "react-router-dom"; //we use link instead of "a" tag & it allows to navigate through the page without refreshing
    ...
    return (
        <div className={style.WelcomeContainer}>
            ...
            <div className={style.actionBtn}>
                ...
                <Link className={style.linkWithoutUnderline}>Have an invite text? Sign in</Link>
            </div>
        </div>
    );
}